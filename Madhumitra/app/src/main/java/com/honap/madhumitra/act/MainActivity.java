...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtName = (TextView) navHeader.findViewById(R.id.doctorName);
        txtWebsite = (TextView) navHeader.findViewById(R.id.doctorAddress);
        imgProfile = (ImageView) navHeader.findViewById(R.id.doctorProfile);
